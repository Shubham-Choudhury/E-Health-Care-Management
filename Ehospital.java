...
class Info {
    Info() {
        ...
        System.out.print(
                "\t\t\t\t\t|                                                                                           |\n");
        System.out.print(
                "\t\t\t\t\t|                                         -Brought To You by Shubham Choudhury              |\n");
        System.out.print(
                "\t\t\t\t\t|___________________________________________________________________________________________|\n");
    }
    ...
    void exit() {
        ...
        System.out.print(
                "\t\t\t\t\t|                                           		                                            |\n");
        System.out.print(
                "\t\t\t\t\t|                         Thank You for E-HEALTH CARE MANAGEMENT SYSTEM                       |\n");
        System.out.print(
                "\t\t\t\t\t|                                                                                             |\n");
        System.out.print(
                "\t\t\t\t\t|                                         -Brought To You by Shubham Choudhury                |\n");
        System.out.print(
                "\t\t\t\t\t|                                         Linkedin:- https://www.linkedin.com/in/shubham017/  |\n");
                System.out.print(
                "\t\t\t\t\t|                                         Github:- https://github.com/Shubham-Choudhury/      |\n");
        System.out.print(
                "\t\t\t\t\t|_____________________________________________________________________________________________|\n");
        System.out.print("\t\t\t\t\t\n\n\n\n\t\t\t\t\t");
        System.exit(0);
